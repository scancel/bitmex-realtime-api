...
WebSocketClient.prototype.open = function(url){
  ...
  this.pingInterval = initPing(this.instance);
...
WebSocketClient.prototype.log = function() {
  ...
  console.log.apply(console, [new Date(), 'Bitmex WebSocket [INFO]:'].concat(args));
}

WebSocketClient.prototype.logError = function() {
  const args = [].slice.call(arguments);
  console.error.apply(console, [new Date(), 'Bitmex WebSocket [ERROR]:'].concat(args));
}
